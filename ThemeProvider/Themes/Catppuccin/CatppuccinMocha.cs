...
public static class CatppuccinMocha
{
	...
	public static ThemeDefinition CreateTheme()
	{
		...
		SemanticColorSpec mantleSpec = new(SemanticMeaning.Secondary, VisualRole.Background, ImportanceLevel.Medium);
		...
		SemanticColorSpec crustSpec = new(SemanticMeaning.Secondary, VisualRole.Background, ImportanceLevel.Low);
		...
		SemanticColorSpec surface0Spec = new(SemanticMeaning.Primary, VisualRole.Surface, ImportanceLevel.Low);
		...
		SemanticColorSpec surface1Spec = new(SemanticMeaning.Primary, VisualRole.Surface, ImportanceLevel.Medium);
		...
		SemanticColorSpec surface2Spec = new(SemanticMeaning.Primary, VisualRole.Surface, ImportanceLevel.High);
		...
		SemanticColorSpec overlay0Spec = new(SemanticMeaning.Secondary, VisualRole.Surface, ImportanceLevel.Low);
		...
		SemanticColorSpec overlay1Spec = new(SemanticMeaning.Secondary, VisualRole.Surface, ImportanceLevel.Medium);
		...
		SemanticColorSpec overlay2Spec = new(SemanticMeaning.Secondary, VisualRole.Surface, ImportanceLevel.High);
		...
		SemanticColorSpec subtext1Spec = new(SemanticMeaning.Secondary, VisualRole.Text, ImportanceLevel.High);
		...
		SemanticColorSpec subtext0Spec = new(SemanticMeaning.Secondary, VisualRole.Text, ImportanceLevel.Medium);
		...
		SemanticColorSpec successTextSpec = new(SemanticMeaning.Success, VisualRole.Text, ImportanceLevel.High);
		...
		SemanticColorSpec warningTextSpec = new(SemanticMeaning.Warning, VisualRole.Text, ImportanceLevel.High);
		...
		SemanticColorSpec errorTextSpec = new(SemanticMeaning.Error, VisualRole.Text, ImportanceLevel.Critical);
		...
		SemanticColorSpec ctaTextSpec = new(SemanticMeaning.CallToAction, VisualRole.Text, ImportanceLevel.High);
		...
		SemanticColorSpec infoTextSpec = new(SemanticMeaning.Information, VisualRole.Text, ImportanceLevel.Medium);
		...
		SemanticColorSpec ctaWidgetSpec = new(SemanticMeaning.CallToAction, VisualRole.Widget, ImportanceLevel.Critical);
		...
		SemanticColorSpec normalWidgetSpec = new(SemanticMeaning.Secondary, VisualRole.Widget, ImportanceLevel.Medium);
		...
		SemanticColorSpec successWidgetSpec = new(SemanticMeaning.Success, VisualRole.Widget, ImportanceLevel.High);
		...
		SemanticColorSpec warningWidgetSpec = new(SemanticMeaning.Warning, VisualRole.Widget, ImportanceLevel.High);
		...
		SemanticColorSpec errorWidgetSpec = new(SemanticMeaning.Error, VisualRole.Widget, ImportanceLevel.Critical);
		...
		SemanticColorSpec infoWidgetSpec = new(SemanticMeaning.Information, VisualRole.Widget, ImportanceLevel.Medium);
		...
		SemanticColorSpec emphasisWidgetSpec = new(SemanticMeaning.Secondary, VisualRole.Widget, ImportanceLevel.High);
		...
		SemanticColorSpec debugWidgetSpec = new(SemanticMeaning.Debug, VisualRole.Widget, ImportanceLevel.Low);
		...
		SemanticColorSpec normalLowWidgetSpec = new(SemanticMeaning.Primary, VisualRole.Widget, ImportanceLevel.Low);
		...
		SemanticColorSpec emphasisTextSpec = new(SemanticMeaning.Secondary, VisualRole.Text, ImportanceLevel.Medium);
